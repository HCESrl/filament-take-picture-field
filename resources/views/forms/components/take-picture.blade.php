        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative w-20 h-20">
                ...
                <template x-if="photoData">
                    ...
                    >
                        ...
                        <div class="absolute bottom-0 right-0 p-1 bg-gray-800 bg-opacity-70 rounded-tl"
                            ...
                            <x-filament::icon class="h-4 w-4 text-white" icon="heroicon-o-pencil-square" />
                        </div>
                        ...
                        <div class="absolute top-0 left-0 p-1 bg-gray-800 bg-opacity-70 rounded-br">
                            <button
                                ...
                                x-show="photoData"
                            >
                                <x-filament::icon class="h-4 w-4 text-white" icon="heroicon-o-eye" />
                            </button>
                        </div>
                ...
                <template x-if="!photoData">
                    ...
                    >
                        <x-filament::icon class="h-8 w-8 text-gray-600" icon="heroicon-o-camera" />
                        ...
                        <div class="relative bg-black rounded-lg overflow-hidden mb-4">
                            ...
                            <template x-if="webcamError">
                                <div class="aspect-video bg-gray-800 flex flex-col items-center justify-center text-center p-6">
                                    <x-filament::icon class="h-8 w-8 text-red-500" icon="heroicon-o-exclamation-triangle" />
                            ...
                            <template x-if="webcamActive && !webcamError">
                                <div class="absolute bottom-4 left-0 right-0 flex justify-center">
                                    <button
                                        ...
                                        title="{{ __('Take Photo') }}"
                                    >
                                        <x-filament::icon class="h-8 w-8 text-white" icon="heroicon-o-camera" />
                                    </button>
                                </div>
                            </template>
                            ...
                            <template x-if="webcamActive && !webcamError">
                                <div class="absolute top-4 right-4">
                                    ...
                                    >
                                        <x-filament::icon class="h-6 w-6" icon="heroicon-o-arrow-path" />
                                    </button>
                                </div>
                            </template>
                            ...
                            <template x-if="webcamActive && !webcamError && isMobile">
                                <div class="absolute top-4 left-4">
                                    ...
                                    >
                                        <x-filament::icon class="h-6 w-6" icon="heroicon-o-arrow-uturn-down" />
                                    </button>
                                </div>
                            </template>
